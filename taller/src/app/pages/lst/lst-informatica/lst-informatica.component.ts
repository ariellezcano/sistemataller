...
@Component({
  selector: 'app-lst-informatica',
  templateUrl: './lst-informatica.component.html',
  styleUrls: ['./lst-informatica.component.scss'],
})
export class LstInformaticaComponent implements OnInit {
  @ViewChild('close')
  cerrar!: ElementRef;
